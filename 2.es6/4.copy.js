// Object.assign... 如果是多层的话 就是浅拷贝 单层就是深拷贝
let obj = { name: 'zxx', age: { n: 18 }, a: undefined, a: function () { }, reg: /\d+/ }
...
function deepClone(value, hash = new WeakMap) { // 弱引用，不要用map
    ...
    if (value == null) { return value; } // null的判断
    if (value instanceof RegExp) { return new RegExp(value) }
    if (value instanceof Date) { return new Date(value) }

    // 函数是不需要拷贝
    if (typeof value != 'object') return value; // typeof Function() === 'function'
